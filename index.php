...
<body class="light">
	<form id="codraz" method="post" action="/control.php">
		...
		<div id="keyzone">
			...
			<input type="text" name="key" id="key" placeholder="Clé de chiffrage" value="<?php if (isset($_SESSION['key'])) {
																								echo $_SESSION['key'];
																								unset($_SESSION['key']);
																							} ?>" />
			<div id="action-bloc">
		...
		<div id="inout">
			<textarea class="form-control" name="inout" placeholder="Tapez votre texte ici..."><?php if (isset($_SESSION['inout'])) {
																									echo $_SESSION['inout'];
																									unset($_SESSION['inout']);
																								} ?></textarea>
			<div id="change-theme">
